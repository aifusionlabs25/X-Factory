#!/usr/bin/env python3
"""Phase 4.4 single-transaction Atlas canary controller.
...
MISSION_ID = "phase4-atlas-canary-001"
STAGE = "ATLAS_TRIAGE"
PACKET = ROOT / "approvals/pending/phase4-atlas-canary-001"
ACTIVATION_MANIFEST = PACKET / "activation-manifest.json"
BASE_MANIFEST = ROOT / "approvals/pending/phase4-live-synthetic-001-revision-003/live-mission-manifest.v0.2.json"
APPROVAL_RECORD = ROOT / "approvals/approved/phase4-atlas-canary-001.activation.approval.json"
...
def build_bound_runner(activation: dict) -> tuple[DerivationBoundRunnerV04, Path]:
    activation_schema_path = ROOT / "contracts/phase4/atlas_runtime_canary_activation.v0.1.schema.json"
    ...
    manifest_schema_path = ROOT / "contracts/phase4/live_mission_manifest.v0.2.schema.json"
...
def main() -> None:
    ...
    executor = BoundStageExecutorV01(runner, ROOT / "scripts/hermes_transaction_bound_bridge.py")
