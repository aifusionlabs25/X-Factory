#!/usr/bin/env python3
"""Phase 4.5 Revision 005 single-transaction Atlas canary controller.
...
STAGE = "ATLAS_TRIAGE"
PACKET = ROOT / "approvals/pending/phase4-atlas-canary-003"
ACTIVATION_MANIFEST = PACKET / "activation-manifest.json"
BASE_MANIFEST = ROOT / "approvals/pending/phase4-live-synthetic-001-revision-005/live-mission-manifest.v0.3.json"
APPROVAL_RECORD = ROOT / "approvals/approved/phase4-atlas-canary-003.activation.approval.json"
...
def build_bound_runner(activation: dict) -> tuple[DerivationBoundRunnerV06, Path]:
    activation_schema_path = ROOT / "contracts/phase4/atlas_runtime_canary_activation.v0.3.schema.json"
    ...
    if file_hash(ROOT / "contracts/phase4/normalized_intake.v0.1.schema.json") != activation["output_schema_sha256"]:
