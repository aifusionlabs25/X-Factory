    ...
    <section class="workspace">
      <div class="conversation">
        ...
        <form id="message-form">
          <label for="message">Check approved knowledge</label>
          <div><input id="message" required autocomplete="off" placeholder="What services do you offer?"><button>CHECK KB</button></div>
        </form>
      </div>
      <aside>
