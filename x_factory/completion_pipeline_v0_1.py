...
def complete_local_draft(mission_id: str) -> dict[str, Any]:
    ...
    record = {
        ...
        "route": [
            ...
            {"order": 5, "specialist": "Source Vault", "job": "Preserve owner-approved source evidence unchanged", "status": "PASS"},
            {"order": 6, "specialist": "OMNARA", "job": "Engineer the traceable client-ready Knowledge Bank", "status": "PASS"},
            {"order": 7, "specialist": "Troy", "job": "Compile the governed production System Prompt", "status": "PASS"},
            {"order": 8, "specialist": "Vera", "job": "Certify Knowledge Studio, behavior, and Prompt Forge packages", "status": "PASS"},
            {"order": 9, "specialist": "Runtime Foundry", "job": "Seal the local runtime candidate", "status": "PASS"},
            {"order": 10, "specialist": "Rook", "job": "Independently rerun tests and attack omissions", "status": "PASS"},
            {"order": 11, "specialist": "Porter", "job": "Package and verify the complete local repository", "status": "PASS"},
        ],
        "review": {
