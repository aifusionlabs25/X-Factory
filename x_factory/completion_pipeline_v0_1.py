...
def complete_local_draft(mission_id: str) -> dict[str, Any]:
    ...
    record = {
        ...
        "route": [
            ...
            {"order": 5, "specialist": "Vera", "job": "Certify deterministic behavior", "status": "PASS"},
            {"order": 6, "specialist": "Rook", "job": "Independently rerun tests and attack omissions", "status": "PASS"},
            {"order": 7, "specialist": "Porter", "job": "Package and verify the complete local repository", "status": "PASS"},
        ],
        "review": {
